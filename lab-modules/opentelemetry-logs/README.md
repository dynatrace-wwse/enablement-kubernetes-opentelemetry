...
Clone the repo:
```sh
git clone --single-branch --branch code-spaces https://github.com/dynatrace-wwse/enablement-kubernetes-opentelemetry/tree/main/lab-modules/opentelemetry-logs.git
```

Move into the lab guide directory:
```sh
cd opentelemetry-logs/lab-guide
```
...
[Notebook](/opentelemetry-logs_dt_notebook.json)
